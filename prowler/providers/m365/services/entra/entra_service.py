...
class Entra(M365Service):
    ...
    def __init__(self, provider: M365Provider):
        ...
        self.user_registration_error: Optional[str] = None
    ...
    async def _get_users(self):
        ...
        try:
            ...
            registration_details, self.user_registration_error = (
    ...
    async def _get_user_registration_details(self):
        ...
        Returns:
            A tuple containing:
            - A dict mapping user IDs to their registration details (each value
              is a dict with 'is_mfa_capable' (bool) and 'authentication_methods'
              (list of str)), or an empty dict if retrieval fails.
            - An error message string if there was an access error, None otherwise.
        """
        ...
        try:
            ...
            ) or error.__dict__.get("response_status_code", None) == 403:
